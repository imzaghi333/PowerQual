...
<div class="fail">
    ...
    if(isset($_POST["fail"]) && $_POST["fail"]=="fail_do"){
        ...
        $checkpoint = $_POST["checkpoint"];        //Next checkpoint date
        $publish = $_POST["publish"];              //Issue Published
        $mfg_date = $_POST["mfg_date"];            //ORT MFG Date
        $report_date = $_POST["report_date"];
        
        echo "<br><p style='color:#337ab7;font: size 16px;'>Info update complete, close it to continue.</p>";
        $sql_update = "UPDATE DQA_Test_Main SET Defectmode1='$df1',Defectmode2='$df2',RCCA='$rcca',Teststatus='$test_status', ";
        $sql_update.= "Issuestatus='$issue_status',Category='$category',PIC='$pic',JIRANO='$jira',SPR='$spr',Temp='$temp', ";
        $sql_update.= "Dropcycles='$drop_cycle',Drops='$drops',Dropside='$drop_side',Hit='$hit_tumble',NextCheckpointDate='$checkpoint', ";
        $sql_update.= "IssuePublished='$publish',ORTMFGDate='$mfg_date',ReportedDate='$report_date' WHERE RecordID='$current_id' ";
